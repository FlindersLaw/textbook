...
see a <DisplayImage imageURL='/img/textbook/copy_button.png' inline /> button.  Click on this to copy the code 
in the snippet.
...
<DisplayImage imageURL='/img/intro01.png' caption='Code properly formatted' />

**Do not** place any leading spaces between the code and the left margin. This will lead to errors.

<DisplayImage imageURL='/img/intro02.png' caption='INCORRECT. Do not start each line with a space' />
:::
