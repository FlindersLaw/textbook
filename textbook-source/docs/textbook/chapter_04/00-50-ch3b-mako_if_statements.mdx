...
flowchart LR;
    ...
    id3 --> id5
    id3 --> id6(Are you studying full time?)
    id3 --> id7(Are you unemployed?)
    id4 --> id5
    id4 -- I am older than 25 --> id6
    id4 -- I am older than 22 --> id7
    id5 --> id8(Add service if yes)
    id6 --> id8
    id7 --> id8
```
...
subquestion: |
  ...
  % if userIsDisabled:
  You may also be eligible for the [Disability Support Pension]
  % elif userAge >= 65:
