...
---
```
This application will first display a button which asks the user whether they are 18 or over. If they are, the final screen will display that they are an adult.
