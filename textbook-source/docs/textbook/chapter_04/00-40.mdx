...
<Components.DisplayImage imageURL='/textbook/img/textbook/chapter_04/welfare_nested_between_18_and_65.png' altText='The options displayed to the user if they say their age is between 18 and 65' />
...
<Components.DisplayImage imageURL='/textbook/img/textbook/chapter_04/welfare_nested_between_18_and_65.png' altText='The text displayed to the user if they say they suffer from a disability.' />
