...
In carpentry, there is a saying; 'measure twice, cut once'. The same is true for legal application design. You should plan what your application will look like before you start writing any code.
...
In [Chapter 3](/docs/textbook/chapter_03/00-10-ch3a-variables_data), you learned about variables. You can *assign* a value to a variable, as well as *evaluate* that variable. 

In [Chapter 4](/docs/textbook/chapter_04/00-20-ch3b-if_statements), you learned about how to use variables to drive the logic of your application.
...
For other applications, you might have two or more endpoints. You can direct users to different endpoints using an ```event:``` tag, followed by a variable name. You can refer to this variable name in your mandatory code block.