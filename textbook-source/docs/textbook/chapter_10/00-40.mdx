...
<Components.DisplayImage imageURL='/textbook/img/textbook/chapter_10/ch10_hint_text_magistrates_court_finder.PNG' altText='A display of the hint text for our magistrate court finder.'/>
...
<Components.DisplayImage imageURL='/textbook/img/textbook/chapter_10/ch10_help_magistrates_court_finder.PNG' altText='Our magistrates court finder with the help icons displayed next to the options.'/>

Clicking on one of these icons will display the help text that we have entered.

<Components.DisplayImage imageURL='/textbook/img/textbook/chapter_10/ch10_help_text_magistrates_court_finder.PNG' altText='A screenshot of the user clicking on the Western Adelaide help text option and displaying the help text.'/>
...
<Components.DisplayImage imageURL='/textbook/img/textbook/chapter_10/ch10_help_menubar_magistrates_court_finder.PNG' altText='A screenshot of our application where we have created a help menu bar that displays the relevant help text.'/>

Clicking on this star will display the help text.

<Components.DisplayImage imageURL='/textbook/img/textbook/chapter_10/ch10_help_menubar_magistrates_court_finder.PNG' altText='The help text from our help menubar.'/>
...
<Components.DisplayImage imageURL='/textbook/img/textbook/chapter_10/ch10_terms_example.PNG' altText='An example of how to use a terms clause in our application.'/>
