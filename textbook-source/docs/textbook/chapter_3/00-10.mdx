...
1. We can embed logic in our <DisplayGlossaryItem item='questionblock' plural /> using `%` tags. You might recall we did this in <DisplayChapter chapter='chapter_2' nourl />:
...
<Components.DisplayImage imageURL='/img/textbook/chapter_3/show_execution_order1.PNG' />

<Components.DisplayImage imageURL='/img/textbook/chapter_3/show_execution_order2.PNG' />
