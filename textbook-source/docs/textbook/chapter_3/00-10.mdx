...
In <Components.DisplayChapter chapter='chapter_2' /> , we learned
...
in <Components.DisplayChapter chapter='chapter_2' nourl />,
...
For example,
in <Components.DisplayChapter chapter='chapter_2' nourl /> we
