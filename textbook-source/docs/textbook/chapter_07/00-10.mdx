...
<DisplayImage imageURL='/textbook/img/textbook/chapter_07/lnfdemo1.png' size="70%" />

and let's turn it into this:

<DisplayImage imageURL='/textbook/img/textbook/chapter_07/lnfdemo2.png' size="70%" />
...
<DisplayImage imageURL='/textbook/img/textbook/chapter_07/developertools1.png'
...
<DisplayImage imageURL='/textbook/img/textbook/chapter_07/developertools_firefox.png'
    caption="Firefox Developer Tools" />
<DisplayImage imageURL='/textbook/img/textbook/chapter_07/developertools_chrome.png'
    caption="Chrome Developer Tools" />
<DisplayImage imageURL='/textbook/img/textbook/chapter_07/developertools_edge.png'
...
<DisplayImage imageURL='/textbook/img/textbook/chapter_07/developertools2.png' />
...
Nonetheless, what we demonstrate in this textbook, and run on Docassemble, will run equally as well in
...
<DisplayImage imageURL='/textbook/img/textbook/chapter_07/staticfilesmenu.png' />

We can add a new CSS file by clicking on 'Add', choosing a name that ends in `.css`:

<DisplayImage imageURL='/textbook/img/textbook/chapter_07/addcssfile.png' />
