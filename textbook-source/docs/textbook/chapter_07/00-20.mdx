...
:::tip
Before you get started you might want to consider setting up a [project](/docs/textbook/chapter_02/00-40#making-a-project)
for your code.
:::
...
### Create a CSS file
First we need to [add a new CSS file in 'Static Files'](#creating-custom-styles).  Let's call the file
