...
Some of you may well be asking 'Why don't we have a `buttons:` tag in our
second question block?' Good question.  You'll have noticed that the second
...
button, well, for free!  No `buttons:` required.
