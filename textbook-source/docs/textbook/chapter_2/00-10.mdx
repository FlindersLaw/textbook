...
<DisplayImage imageURL='/img/textbook/chapter_2/code_block1.png' />
</details>

Your text editor should look like this:

<DisplayImage imageURL='/img/textbook/chapter_2/hello_world2.png' altText='Code in text editor' />
...
Press <DisplayDAButtons button={Constants.da_save_and_run_prop} />. Your program
will run and should display this output:

<DisplayImage altText='Hello World output' imageURL='/img/textbook/chapter_2/hello_world3.png' />
