...
<Components.DisplayImage imageURL='/img/textbook/chapter_2/hello_world5-1.png' />
...
<Components.DisplayImage imageURL='/img/textbook/chapter_2/hello_world5-2.png' />
...
<Components.DisplayImage imageURL='/img/textbook/chapter_2/hello_world5-3.png' />
...
<Components.DisplayImage imageURL='/img/textbook/chapter_2/hello_world5-4.png' />


The document will be uploaded and appear in your 'Existing template files' list.
<Components.DisplayImage imageURL='/img/textbook/chapter_2/hello_world5-5.png' />
...
<Components.DisplayImage imageURL='/img/textbook/chapter_2/hello_world5-6.png' />
...
<Components.DisplayImage imageURL='/img/textbook/chapter_2/hello_world5-7.png' />
...
## A Recap
So far in Chapter 2 we have progressed from making a basic 'hello world' 
...
* Docassemble loks for mandatory blocks to execute from the top down and it
...
* <Components.DisplayGlossaryItem item='mako' upper /> is not a shark.
And <Components.DisplayGlossaryItem item='jinja' upper /> is not a spice!