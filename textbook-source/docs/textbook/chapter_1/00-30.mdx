...
import {da_declared_variable, da_unused_variable, da_undeclared_variable} from '@site/src/constants'
...
![image](/img/textbook/chapter_1/docassemble_main_screen2.png)
...
### 4. Buttons
The *Save* and *Save and Run* buttons do what you would expect, as do the *Download* and *Delete* buttons.
...
* variables properly defined appear in <Highlight color={da_declared_variable}>blue</Highlight>
* variables that are not used appear in <Highlight color={da_unused_variable}>orange</Highlight>;
* variables that Docassemble expects to find but can't (ie: 'undefined variables') appear in <Highlight color={da_undeclared_variable}>dark red</Highlight>.
...
![image](/img/textbook/chapter_1/docassemble_main_screen3.png)

:::tip TODO
Images need borders.  This looks ugly!
:::