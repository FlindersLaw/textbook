...
<DisplayImage imageURL='/img/textbook/chapter_1/docassemble_after_signin_screen_annotated.png' />
...
<DisplayImage imageURL='/img/textbook/chapter_1/docassemble_main_screen1.png' />
...
4. Press <DisplayDAButtons button={Constants.da_save_prop} />

#### Folders
We only have five folders.  We cannot, and do not need to, create any more.

<DisplayImage imageURL='/img/textbook/chapter_1/docassemble_main_screen2.png' />
...
### 4. Buttons
The <DisplayDAButtons button={Constants.da_save_prop} />
and <DisplayDAButtons button={Constants.da_save_and_run_prop} /> buttons
do what you would expect, as do
the <DisplayDAButtons button={Constants.da_download_prop} />
 and <DisplayDAButtons button={Constants.da_delete_prop} /> buttons.
...
* variables properly defined appear in <Highlight color={Constants.da_declared_variable}>blue</Highlight>
* variables that are not used appear in <Highlight color={Constants.da_unused_variable}>orange</Highlight>;
* variables that Docassemble expects to find but can't (ie: 'undefined variables') appear in <Highlight color={Constants.da_undeclared_variable}>dark red</Highlight>.
...
<DisplayImage imageURL='/img/textbook/chapter_1/docassemble_main_screen3.png' />