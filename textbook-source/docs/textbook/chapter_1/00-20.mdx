...
large projects.  We'll only be using a subset of GitHub's features and <Components.DisplayChapter chapter='6' /> will take you through how to use GitHub in detail.  For now, we just need to sign up and connect GitHub and Docassemble together.
