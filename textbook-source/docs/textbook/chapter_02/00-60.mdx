...
get an error:
<Components.DisplayImage imageURL='/textbook/img/textbook/chapter_02/vitalstatistics-1.png' />
...
<Components.DisplayImage imageURL='/textbook/img/textbook/chapter_02/vitalstatistics-2.png' />
...
this:
<Components.DisplayImage imageURL='/textbook/img/textbook/chapter_02/vitalstatistics-4.png' />
Is rounded to this:
<Components.DisplayImage imageURL='/textbook/img/textbook/chapter_02/vitalstatistics-5.png' />

Just like the `integer` data type, it is not possible to enter non-integer 
values, such as characters:
<Components.DisplayImage imageURL='/textbook/img/textbook/chapter_02/vitalstatistics-6.png' />
or even the dollar sign!
<Components.DisplayImage imageURL='/textbook/img/textbook/chapter_02/vitalstatistics-7.png' />
...
<Components.DisplayImage imageURL='/textbook/img/textbook/chapter_02/vitalstatistics-8.png' />
and if we select `No` for `MJFisemployed` then the question is hidden:
<Components.DisplayImage imageURL='/textbook/img/textbook/chapter_02/vitalstatistics-9.png' />
...
<Components.DisplayImage imageURL='/textbook/img/textbook/chapter_02/vitalstatistics-3.png' />
...
<Components.DisplayImage imageURL='/textbook/img/textbook/chapter_02/vitalstatistics-10.png' />
