...
1. Click on the <Components.DisplayImage altText='Add' imageURL='/textbook/img/textbook/add_button.png' inline />
...
<Components.DisplayImage imageURL='/textbook/img/textbook/chapter_02/execution_order1.png' />
...
that block.  That causes this question to be asked:
  <Components.DisplayImage imageURL='/textbook/img/textbook/chapter_02/execution_order2.png' />
...
Mako to process, Docassemble is ready to display this question block, which it does.
  <Components.DisplayImage imageURL='/textbook/img/textbook/chapter_02/execution_order3.png' />
...
<Components.DisplayImage imageURL='/textbook/img/textbook/chapter_02/execution_order4.png' />
