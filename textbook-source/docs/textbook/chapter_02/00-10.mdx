...
<Components.DisplayImage imageURL='/textbook/img/textbook/chapter_02/hello_world1.png' />
...
<Components.DisplayImage imageURL='/textbook/img/textbook/chapter_02/code_block1.png' />
</details>

Your text editor should look like this:

<Components.DisplayImage imageURL='/textbook/img/textbook/chapter_02/hello_world2.png' altText='Code in text editor' />
...
<Components.DisplayImage altText='Hello World output' imageURL='/textbook/img/textbook/chapter_02/hello_world3.png' />
