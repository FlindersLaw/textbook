...
1. Click on the 'Show selected families' <DisplayImage imageURL='/textbook/img/textbook/chapter_06/filter/selectedfamily.png' inline /> icon
...
<DisplayImage imageURL='/textbook/img/textbook/chapter_06/filter/coding14.png' />
