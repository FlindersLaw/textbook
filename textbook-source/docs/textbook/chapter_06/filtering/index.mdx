...
:::tip TODO
List out what's covered in some special format at the beginning
...
- table blocks
(what else?)
- `format()`.  Do we deal with this somewhere else? - Yes! http://localhost:3000/docs/textbook/chapter_03/00-20#using-format
:::
