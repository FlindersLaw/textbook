---
title: Filtering and Advanced Iteration
---
...
- [lists](/docs/textbook/chapter_05/00-20)
- [dictionaries](/docs/textbook/chapter_05/00-40)
- [lists of dictionaries](/docs/textbook/chapter_05/00-50#multidimensional-data) (multidimensional data)
- [iteration](/docs/textbook/chapter_05/00-30)
- [styling using CSS](/docs/textbook/chapter_07/)
- [include blocks](/docs/recipes/structuring_code)
- [table blocks](/docs/recipes/table_blocks)
- [using `format()`](/docs/textbook/chapter_03/00-20#using-format) to present strings
:::
