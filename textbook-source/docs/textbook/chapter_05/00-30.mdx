...
<DisplayImage imageURL='/textbook/img/textbook/chapter_05/bread_types1.png' />
...
<DisplayImage imageURL='/textbook/img/textbook/chapter_05/codeefficiencynirvana.png' size="65%" />
