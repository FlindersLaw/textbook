...
data types, such as <DisplayGlossaryItem item='integer' plural />,
<DisplayGlossaryItem item='string' plural /> and 
<DisplayGlossaryItem item='boolean' plural />.  In this chapter we'll discuss
...
We can collect all that information with a set of string variables and an integer variable,
