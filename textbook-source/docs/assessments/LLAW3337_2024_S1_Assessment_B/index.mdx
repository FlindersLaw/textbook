...
1. qeries about pilots' logbooks;
...
assessment we will deal with only the *Civil Aviation Safety Regulations 1988* (Cth) (**CASR**)
...
<DisplayChapter chapter='chapter_08' /> and in the [case study](/docs/textbook/chapter_06/flitering/00-60#pdf-attachment).

## Making the app beautiful
RKS want an app that follows the colours in their logo.  The rest is left up to our discretion.
Refer to <DisplayChapter chapter='chapter_07' /> and the [case study](/docs/textbook/chapter_06/flitering/00-60)
