...
<DisplayImage imageURL='/img/textbook/Assessments/upload1.png' />
...
<DisplayImage imageURL='/img/textbook/Assessments/upload2.png' />
<DisplayImage imageURL='/img/textbook/Assessments/upload3.png' />
...
<DisplayImage imageURL='/img/textbook/Assessments/upload4.png' />
:::
...
<DisplayImage imageURL='/img/textbook/Assessments/upload5.png' caption='Empty Playground :-(' />
...
<DisplayImage imageURL='/img/textbook/Assessments/upload6.png' caption='Playground with project files' />

## Create a Package for export
Go to Folders -> Packages

<DisplayImage imageURL='/img/textbook/Assessments/upload7.png' />

### Set Package metadata
* Give your package a name
* Check the other information fields are correct.

<DisplayImage imageURL='/img/textbook/Assessments/upload8.png' />
...
<DisplayImage imageURL='/img/textbook/Assessments/upload9.png' />
...
1. Select **Upload**
<DisplayImage imageURL='/img/textbook/Assessments/upload10.png' />
1. Upload your zip file
1. In the package window you should see your package information
<DisplayImage imageURL='/img/textbook/Assessments/upload11.png' />
