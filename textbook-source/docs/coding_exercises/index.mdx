...
:::note
You do **not** need to complete the [Connect to GitHub](/docs/textbook/chapter_01/00-20) part 
of <DisplayChapter chapter='chapter_01' />.  You do not need access to GitHub to complete these
coding exercises.
:::
