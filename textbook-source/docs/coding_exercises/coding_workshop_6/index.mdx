...
In this workshop we're going to look at how to make our app beautiful.
...
We are going to work in our `CodingWorkshop5` Project.  We will use the code from [Exercise 5b](../coding_workshop_5/cw5b) and work from there.

## Steps
### Let's get ready
1. Go to your `CodingWorkshop5` project
1. Copy <DisplayChapter chapter='chapter_07' pinpoint='00-30#stylescss' text='styles.css' /> from Chapter 7 into your `Static Files` folder.
