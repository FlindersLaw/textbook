...
We are going to work in our `CodingWorkshop2` Project.  We will use the code from [Exercise 5b](/docs/coding_exercises/coding_workshop_5/cw5b) and work from there.
