import * as Ex1f from './ex1f.mdx';
export const title = 'Exercise 1g';
...
Extend your code from **{Ex1f.title}** to do the following:
...
:::tip Hints
* You can use [`show if`](https://docassemble.org/docs/fields.html#show%20if)
to display the partner details if the user has a partner
