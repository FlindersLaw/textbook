...
export const video = <div>
    ...
    <span>, </span>
    <a href="/docs/textbook/chapter_03/00-30">Testing Variables</a>
    <span>, </span>
    <a href="/docs/textbook/chapter_04/00-50">Mako if statements</a>
    </div>
...
This code is very similar to the code in [Exercise 4a](../cw4a.mdx), the difference being
...
the Python list displayed in [Exercise A](../cw4a.mdx) which was very much the raw Python
