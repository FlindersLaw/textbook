...
<DisplayImage imageURL='/textbook/img/coding_exercises/genis.png' align="right" size="10%" />
## The Exercise
...
<DisplayImage imageURL='/textbook/img/coding_exercises/dead_cat.jpg' size="20%" />
:::