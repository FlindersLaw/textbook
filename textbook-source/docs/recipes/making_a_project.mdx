...
<DisplayImage imageURL='/textbook/img/textbook/chapter_02/github1.png' />

Click on 'Add a New Project'
<DisplayImage imageURL='/textbook/img/textbook/chapter_02/github2.png' />

Create a new project called `TeachingCode` and press <DisplayDAButtons button={Constants.da_save_prop} />
<DisplayImage imageURL='/textbook/img/textbook/chapter_02/github3.png' />
...
then click 'Packages'
<DisplayImage imageURL='/textbook/img/textbook/chapter_02/github4.png' />

Click 'Pull'
<DisplayImage imageURL='/textbook/img/textbook/chapter_02/github5.png' />

In the GitHub URL enter <DisplayConstants data={teachingcodeurl} />
<DisplayImage imageURL='/textbook/img/textbook/chapter_02/github6.png' />
...
<DisplayImage imageURL='/textbook/img/textbook/chapter_02/github7.png' />
